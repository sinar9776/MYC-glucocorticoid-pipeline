...
de_tbl  <- file.path(base_root, "results_0.05/1_DEAnalysis/tables/shrunk")
int_tbl <- file.path(base_root, "results_0.05/2_interaction/tables")
out_tbl <- file.path(base_root, "results_0.05/4_categories/tables")
out_fig <- file.path(base_root, "results_0.05/4_categories/figures")
